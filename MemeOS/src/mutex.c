...
void kthread_mutex_init(volatile kthread_mutex_t *mutex)
{
	// 1 = unlocked, 0 = locked
	mutex->flag = 1;
}
...
void kthread_mutex_destroy(volatile kthread_mutex_t *mutex) { return; }


void kthread_mutex_lock(volatile kthread_mutex_t *mutex)
{
...
void kthread_mutex_unlock(volatile kthread_mutex_t *mutex) { mutex->flag = 1; }
